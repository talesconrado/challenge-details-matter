//
//  PetDetailsActivitiesCollection.swift
//  DetailsMatter
//
...
class PetDetailsActivitiesCollection: UICollectionView {
    ...
    private func registerCell() {
        ...
        self.register(activityNib, forCellWithReuseIdentifier: PetDetailsActivityCell.identifier)
    }
}
